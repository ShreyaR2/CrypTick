...
const Coin = () => {
    ...
    const [tokenAddress,setTokenAddress] = useState("0xf8Fb3713D459D7C1018BD0A49D19b4C44290EBE5"); //by defualt set one 

    const tokens = [
        {name:"usdt",address:"0x7169D38820dfd117C3FA1f22a697dBA58d90BA06"},
        {name:"uni",address:"0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984"},
        {name:"ChainLink Token (LINK)",address:"0x779877A7B0D9E8603169DdbD7836e478b4624789"},
    ...
    useEffect(()=>{
        ...
        const foundToken = tokens.find(token => token.name === name);
        if (foundToken) {
